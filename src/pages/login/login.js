    ...
    <Layout>
      <Content className="flex items-center justify-center h-screen">
        <div className="w-80 p-6 bg-white rounded-lg shadow-md">
          ...
          <Text className="mb-4 block text-gray-500">Please enter your login details to sign in</Text>
          <Form onFinish={onFinish}>
            ...
            <Form.Item name="password" rules={[{ required: true, message: 'Please enter your password' }]}>
              ...
              <Text type="danger" className="block mt-2">Forgot Password?</Text>
            </Form.Item>
            <Form.Item>
          ...
          <Text className="block mt-4 mb-2 text-center">Don’t have an account? <a href="#">Create an account</a></Text>
